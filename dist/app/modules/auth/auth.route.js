...
router.get('/reset-password-page', auth_controller_1.authControllers.resetPasswordLink);
router.get('/password-reset-success', (req, res) => {
    res.render('successMessage', {
        hadeTitle: 'Password Reset Successful',
        title: 'Password Reset Successful 🎉',
        description: 'Your password has been updated securely. You can now log in with your new credentials.',
    });
});
