...
const login = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield auth_service_1.authServices.login(req.body, req);
...
const googleLogin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield auth_service_1.authServices.googleLogin(req.body, req);
    const { refreshToken } = result;
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const cookieOptions = {
        secure: false,
...
const resetPasswordLink = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const token = req.query.token;
    const result = yield auth_service_1.authServices.resetPasswordLink(token);
