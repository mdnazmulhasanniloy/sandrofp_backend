...
router.post('/', upload.single('profile'), (0, parseData_1.default)(), (0, validateRequest_1.default)(user_validation_1.userValidation === null || user_validation_1.userValidation === void 0 ? void 0 : user_validation_1.userValidation.guestValidationSchema), user_controller_1.userController.createUser);
router.patch('/update-my-profile', (0, auth_1.default)(user_constants_1.USER_ROLE.admin, user_constants_1.USER_ROLE.sub_admin, user_constants_1.USER_ROLE.super_admin, user_constants_1.USER_ROLE.user), upload.single('profile'), (0, parseData_1.default)(), user_controller_1.userController.updateMyProfile);
