...
router.post('/', (0, auth_1.default)(user_constants_1.USER_ROLE.super_admin, user_constants_1.USER_ROLE.sub_admin, user_constants_1.USER_ROLE.admin), upload.fields([{ name: 'banner', maxCount: 5 }]), (0, parseData_1.default)(), 
