...
const getAllContents = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield contents_models_1.default.findOne({});
    if (query === null || query === void 0 ? void 0 : query.key) {
        return result === null || result === void 0 ? void 0 : result[query.key];
    }
    else {
        return result;
    }
