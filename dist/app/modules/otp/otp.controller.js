...
const verifyLink = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield otp_service_1.otpServices.verifyLink(req === null || req === void 0 ? void 0 : req.query);
    return res.render('successMessage', {
        hadeTitle: 'OTP Verification',
        title: 'Account Verified!',
        description: ' Congratulations! Your account has been successfully verified. You can  now log in and start using our services.',
    });
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
