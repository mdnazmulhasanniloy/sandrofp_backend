...
const resendOtp = (email) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, mailSender_1.sendEmail)(user === null || user === void 0 ? void 0 : user.email, 'Your One Time OTP', fs_1.default
        ...
        .replace('{{verifyUrl}}', `${config_1.default.server_url}/otp/verify-link?token=${token}`.trim()));
    return { token };
});
const verifyLink = (query) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (user.verification.status) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, 'this link well be expired.');
    }
    if (new Date() > ((_a = user === null || user === void 0 ? void 0 : user.verification) === null || _a === void 0 ? void 0 : _a.expiresAt)) {
        throw new AppError_1.default(http_status_1.default.FORBIDDEN, 'token has expired. Please resend it');
    }
    const updateUser = yield user_models_1.User.findByIdAndUpdate(user === null || user === void 0 ? void 0 : user._id, {
        $set: {
            verification: {
    ...
    }, { new: true }).select('email _id username role name');
    return updateUser;
});
exports.otpServices = {
    verifyOtp,
